...
function App() {
  ...
  const [runtimeConfig, setRuntimeConfig] = useState<RuntimeConfigSnapshot>({ manifest: {}, tests: DEFAULT_TEST_CONFIGURATION, source: 'fallback' });
  ...
  const finishTest = (testResult: TestResult) => {
    ...
    const calculated = calculateDiagnosticResult(nextResults, preferences, candidates, resultMode, { beginner: profile.experience === 'beginner' });
