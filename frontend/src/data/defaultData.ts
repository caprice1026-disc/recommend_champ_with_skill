...
export const DEFAULT_CHAMPION_LANES: ChampionLaneProfile[] = [
  ...
  profile('kindred', 'キンドレッド', 'JUNGLE', { prediction: 0.8, attentionDistribution: 0.85, decisionQuality: 0.75, taskSwitching: 0.7 }, { prediction: 0.6, attentionDistribution: 0.55 }, { independence: 0.7, mapInfluencePreference: 0.95, lateGameFocus: 0.65, rangePreference: 0.65 }, ['prediction', 'attentionDistribution'], ['先読み', 'マップ影響'], ['判断の複雑さ']),
